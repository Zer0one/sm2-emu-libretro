...
public:
    ...
    /// Whether the peers required by this transport are present. Socket based
    /// standalone transports are ready as soon as they are connected; a
    /// frontend session may need to wait for the other cabinet to join.
    [[nodiscard]] virtual bool ready() const { return connected(); }
